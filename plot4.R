...
par(mfrow=c(2,2))
plot(x = power2.df$Date.Time, y = power2.df$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xlab ="")
plot(x = power2.df$Date.Time, y = power2.df$Voltage, type = "l", ylab = "Voltage", xlab ="datetime")
...
plot(x = power2.df$Date.Time, y = power2.df$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab ="datetime")
dev.off()